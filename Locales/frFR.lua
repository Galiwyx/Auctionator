...
AtrL["SCAN_EXPLANATION"] =  "<br />"
              ...
              .."- afficher le prix moyen des objets disponibles à la vente dans votre inventaire<br/>- recommander un prix moyen si aucune vente n'est en cours au moment de la création de votre vente"
              .."<br /><br />"
              .."Si le scan provoque une déconnexion du jeu, rendez-vous sur |cFFffd100https://github.com/Auctionator/Auctionator/wiki|r pour trouver une solution adaptée.<br /><br />"
...
AtrL["Show disenchant prices in tooltips"] = "Afficher le prix du désenchantement dans les inf-bulles"
